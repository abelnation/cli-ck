        ...
        describe('config', function() {
            ...
            describe('required', function() {
                ...
                it('required opts cannot be count or explicit boolean', function() {
                    assert.throws(function() { new Option('test', { required: true, count: true }) })
                    assert.throws(function() { new Option('test', { required: true, boolean: true }) })
                })
            })
            ...
            describe('aliases', function() {
                ...
                it('takes an array of strings', function() {
                    ...
                    var expected = [ name ].concat(alias)
                    assert.deepEqual(opt.getAliases(), expected )
                })
            })
