    ...
    describe('.validate', function() {
        ...
        describe('num args', function() {
            ...
            it('does not complain if nargs within bounds', function() {
                assert.doesNotThrow(function() { cli.validate('a b') })
                assert.doesNotThrow(function() { cli.validate('a b c') })
                assert.doesNotThrow(function() { cli.validate('--foo a --bar b c -xyz') })
            })
        ...
        describe('required options', function() {
            ...
            it('does not complain if required args provided', function() {
                assert.doesNotThrow(function() { cli.validate('--a test --b') })
            })
